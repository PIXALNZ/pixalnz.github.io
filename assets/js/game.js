...
function showHelp(modal, type){
	let exampleWords = ['AROHA', 'TOITŪ', 'PŌNGA'];
...
function addSocial(loc){
	...
	facebookIcon.src = './assets/img/social/Facebook-logo.png';
	facebookIcon.title = 'Follow me on FaceBook';
	facebookIcon.alt = 'FaceBook';
	facebookIcon.addEventListener("click", function(){
		openWindow('https://www.facebook.com/PPixAL/', 'FaceBook');
	});
